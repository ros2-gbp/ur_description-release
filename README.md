## ur_description (humble) - 2.14.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Mon, 21 Sep 2026 12:08:20 -0000`
...
## ur_description (humble) - 2.13.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Wed, 22 Jul 2026 10:17:32 -0000`
...
## ur_description (humble) - 2.12.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Fri, 17 Jul 2026 09:42:25 -0000`
...
## ur_description (humble) - 2.11.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Wed, 13 May 2026 09:33:05 -0000`
...
## ur_description (kilted) - 4.3.1-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro kilted` on `Thu, 07 May 2026 08:13:25 -0000`
...
## ur_description (jazzy) - 3.5.1-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro jazzy` on `Thu, 07 May 2026 08:06:45 -0000`
...
## ur_description (humble) - 2.10.1-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Thu, 07 May 2026 08:00:32 -0000`
...
## ur_description (humble) - 2.10.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Wed, 08 Apr 2026 13:12:51 -0000`
...
## ur_description (humble) - 2.9.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Thu, 04 Dec 2025 15:15:48 -0000`
...
## ur_description (jazzy) - 3.5.0-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro jazzy` on `Fri, 24 Oct 2025 10:40:54 -0000`
...
## ur_description (kilted) - 4.3.0-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro kilted` on `Tue, 14 Oct 2025 11:14:00 -0000`
...
## ur_description (rolling) - 4.3.0-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro rolling` on `Tue, 14 Oct 2025 10:05:42 -0000`
...
## ur_description (humble) - 2.8.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Mon, 13 Oct 2025 08:39:03 -0000`
...
## ur_description (jazzy) - 3.4.0-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro jazzy` on `Mon, 13 Oct 2025 08:26:35 -0000`
...
## ur_description (kilted) - 4.2.0-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro kilted` on `Mon, 13 Oct 2025 08:11:02 -0000`
...
## ur_description (rolling) - 4.2.0-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro rolling` on `Mon, 13 Oct 2025 08:02:25 -0000`
...
## ur_description (rolling) - 4.1.1-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro rolling` on `Wed, 01 Oct 2025 09:53:47 -0000`
...
## ur_description (kilted) - 4.1.1-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro kilted` on `Wed, 01 Oct 2025 09:50:19 -0000`
...
## ur_description (humble) - 2.7.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro humble` on `Mon, 15 Sep 2025 09:15:33 -0000`
...
## ur_description (jazzy) - 3.3.0-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro jazzy` on `Mon, 15 Sep 2025 09:03:57 -0000`
...
## ur_description (kilted) - 4.1.0-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro kilted` on `Mon, 15 Sep 2025 08:57:54 -0000`
...
## ur_description (rolling) - 4.1.0-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/home/feex/.local/bin/bloom-release ur_description --rosdistro rolling` on `Mon, 15 Sep 2025 08:41:25 -0000`
...
## ur_description (jazzy) - 3.2.0-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release ur_description --rosdistro jazzy --edit` on `Tue, 20 May 2025 11:11:28 -0000`
...
## ur_description (humble) - 2.6.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/usr/bin/bloom-release ur_description --rosdistro humble` on `Tue, 20 May 2025 09:01:44 -0000`
...
## ur_description (kilted) - 4.0.0-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/usr/bin/bloom-release ur_description --rosdistro kilted` on `Thu, 15 May 2025 09:37:10 -0000`
...
## ur_description (rolling) - 4.0.0-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_description --rosdistro rolling` on `Thu, 15 May 2025 09:32:31 -0000`
...
## ur_description (rolling) - 3.1.1-2

The packages in the `ur_description` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_description --rosdistro rolling` on `Thu, 15 May 2025 09:08:34 -0000`
...
## ur_description (rolling) - 3.1.1-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_description --rosdistro rolling` on `Mon, 05 May 2025 10:25:55 -0000`
...
## ur_description (kilted) - 3.1.1-1

The packages in the `ur_description` repository were released into the `kilted` distro by running `/usr/bin/bloom-release ur_description --rosdistro kilted` on `Mon, 05 May 2025 09:33:31 -0000`
...
## ur_description (jazzy) - 3.1.1-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release ur_description --rosdistro jazzy` on `Mon, 05 May 2025 09:24:43 -0000`
...
## ur_description (rolling) - 3.1.0-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_description --rosdistro rolling` on `Wed, 02 Apr 2025 08:01:19 -0000`
...
## ur_description (jazzy) - 3.1.0-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release ur_description --rosdistro jazzy` on `Wed, 02 Apr 2025 07:57:30 -0000`
...
## ur_description (humble) - 2.5.0-1

The packages in the `ur_description` repository were released into the `humble` distro by running `/usr/bin/bloom-release ur_description --rosdistro humble` on `Wed, 02 Apr 2025 07:52:00 -0000`
...
## ur_description (rolling) - 3.0.2-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ur_description --rosdistro rolling` on `Mon, 17 Mar 2025 12:35:23 -0000`
...
## ur_description (jazzy) - 3.0.2-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release ur_description --rosdistro jazzy` on `Mon, 17 Mar 2025 12:31:45 -0000`
...
## ur_description (jazzy) - 3.0.1-1

The packages in the `ur_description` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy ur_description` on `Thu, 23 Jan 2025 12:30:23 -0000`
...
## ur_description (rolling) - 3.0.1-1

The packages in the `ur_description` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling ur_description` on `Thu, 23 Jan 2025 12:23:03 -0000`
...
## ur_description (rolling) - 3.0.0-1
...
## ur_description (rolling) - 2.4.2-1
